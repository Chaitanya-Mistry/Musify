        ...
        <>
            <div className="members">
                ...
                <div className="memberContact">
                    <a href={devData.linkedIn} target="_blank" alt-text="Linkedin link of developers">
                        <span className="fa-brands fa-linkedin faIcons" style={{ color: "dodgerblue" }}  alt="Linkedin link of developers"></span>
                    </a>
                    <a href={devData.gitHub} target="_blank" alt="github link of developers">
